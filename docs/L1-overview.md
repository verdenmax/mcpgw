...
cargo test --all-features   # 全部测试（182 passed / 3 ignored：catalog 4 / config 35 /
                            #   retrieval 20 + caching 4 + embedder 3 + golden 1 + hybrid 6 + subagent 7 + vector 6 /
                            ...
                            #   observe 6 + capture 1 /
                            #   downstream 4 + e2e(stdio) 8 + e2e(http) 5 ·
