...
<div class="card warn">
  ...
  <ul>
    ...
    <li><strong><span class="inline">strategy = "vector"</span> 只在 <span class="inline">serve</span>（活网关）下生效</strong>：
      ...
      <span class="inline">search</span> 分支调用 <span class="inline">build_strategy(&amp;cfg.retrieval.strategy, None)</span>，
      于是会<strong>直接报错 <span class="inline">StrategyError::EmbedderRequired</span></strong>，
      <strong>不是</strong>静默退回 BM25、也不是“形同未配置”。</li>
