...
<div class="layers">
  ...
  <div class="layer l-part">
    ...
    <div class="ld">检索策略（BM25 / Vector）+ 云端嵌入的 HTTP 后端（仅 embedder 带 HTTP）。</div>
  </div>
...
<div class="card detail">
  ...
  <ul>
    ...
    <li><strong>HTTP 依赖被隔离在独立的 <span class="inline">embedder</span> crate</strong>（<span class="inline">reqwest 0.13</span> + rustls）——
      它是全工作区<strong>唯一</strong>带 HTTP 依赖的 crate，承载真实嵌入后端 <span class="inline">OpenAiEmbedder</span>。</li>
  </ul>
  <div class="codefile">
...
<div class="card key">
  ...
  <ul>
    ...
    <li>越底层越纯：<span class="inline">catalog</span> 无兄弟依赖、<span class="inline">retrieval</span> 无 HTTP，HTTP 只在 <span class="inline">embedder</span>。</li>
